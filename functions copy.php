...
// Simple Perfect Coding navigation
	...
	function bootstrap_setup(){
		...
		class Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu {
			...
			function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
				...
				$attributes .= ($args->has_children) 	    ? ' class="disabled dropdown-toggle" data-toggle="dropdown" ' : '';
...
# Activate this hook to add a logo inside the menu
...
# activate this hook to add a special class to the menu item
